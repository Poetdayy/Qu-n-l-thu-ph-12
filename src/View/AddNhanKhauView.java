...
public class AddNhanKhauView extends javax.swing.JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(backtoNhanKhauView)) {
            ...
            NhanKhauModel nk = btnThemClick();
            if (nkDAO.addNhanKhau(nk) > 0) {
                JOptionPane.showMessageDialog(rootPane, "Them thanh cong");
            }
            else{
                JOptionPane.showMessageDialog(this, "Bạn chưa điền dữ liệu cần nhập");
            }
    ...
    public NhanKhauModel btnThemClick() {
